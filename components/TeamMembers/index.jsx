    ...
    <>
      {showModal && (
        ...
        <div className="block md:hidden">
          <div className="fixed z-50 inset-0 overflow-y-auto font-montserrat">
            <div className={data.name === "Nick Danso Adjei" ? `h-screen sm:block sm:p-0 bg-black/40` : `h-fit 2xl:h-screen sm:block sm:p-0 bg-black/40`}>
              <div className="flex flex-col p-2 animate-in slide-in-from-top duration-700">
                <div
                  className="flex justify-end mb-4 hover:cursor-pointer text-white hover:text-[#f608e2]"
                  onClick={handleCloseModal}
                >
                  <IoMdClose size={30} />
                </div>
                <div className="bg-white rounded-lg p-8 mx-auto shadow-sm ">
                  <div className="w-48 h-48 rounded-full bg-gray-200/20 mx-auto">
                    <Image
                      src={data.img.src}
                      alt="User Image"
