...
function TeamItem({
  ...
  return (
    <>
      <div
        className="col-xl-4 col-md-6 col-12 hover:cursor-pointer hidden sm:block"
        onClick={() => {
          setShowModal(true);
          setData({
            name: name,
        ...
        >
          <div className="member-img">
            <Image
              ...
              alt="member"
              className={
                name.toUpperCase() === "ALIDU ZAKARIA" ||
                name.toUpperCase() === "MARTIN OHENE ANIM"
      ...
      <div
        className="col-xl-4 col-md-6 col-12 hover:cursor-pointer block md:hidden"
        onClick={() => {
          setShowModal(true);
          setData({
            name: name,
        ...
        >
          <div className="member-img">
            <Image
              ...
              className={
                name.toUpperCase() === "ALIDU ZAKARIA"
                  ? `w-screen h-screen object-cover mt-[-60%]`
