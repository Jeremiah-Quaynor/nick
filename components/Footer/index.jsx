  ...
  return (
    <>
            ...
            <div className="space-y-4 w-[30%]">
              ...
              <div className="space-y-2">
                ...
                <div className="text-white">
                  ...
                  company incorporated under the company{"’"}s code and
                  authorized to trade in petroleum products. Nick Petroleum was
                  incorporated in 2015, however, trading commenced in 2016 to
                  supply petroleum products to our retail outlets.
                </div>
              </div>
      ...
      <div className="block md:hidden">
        <div className="bg-[#0a113b] w-screen">
          <div className="flex flex-col mx-auto p-5 space-y-10">
            <div className="">
              <div className="mt-[-10%] 2xl:mt-[-5%]">
                <Image src={Logo} alt="Logo" width={100} height={100} />
              </div>
        ...
        <div className="w-screen bg-[#292f54]">
          <div className="mx-auto text-sm text-white text-left p-5">
            © Copyright 2023 Nick Petroleum. All Rights Reserved.
          </div>
        </div>
      </div>
